...
modelName = 'BCN_CP1_PredSim_noSphere.osim';
DataPath = pwd;
...
for c = 1:IK.nc-1
    ...
    IKgs_exp_mean(:,c) = mean(IKc{c},2);
    IKgs_exp_std(:,c) = std(IKc{c},[],2);
...
%     title(IDlabel{c})
% end
save(['IK_gaitcycle_' subName '_left.mat'],'IKgs_exp_mean','IKgs_exp_std','IKlabel')
